        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">azizbekzaripov003@gmail.com</span>

               <a href="https://azizbekzaripov998@gmail.com" className="contact__button">Write me
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+998(93)-333-46-31</span>

              <a href="https://t.me/zaripov_033" className="contact__button">Write me
                <i className="bx bx-right-arrow-alt contact__button-icon">
                </i></a>
            </div>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">zaripov_033</span>

              <a href="https://www.instagram.com/zaripov_033" className="contact__button">Write me
                <i className="bx bx-right-arrow-alt contact__button-icon">
                </i></a>
            </div>
          </div>
